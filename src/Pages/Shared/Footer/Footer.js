...
const Footer = () => {
    return (
        <footer className="footer p-16 mt-10 bg-neutral text-neutral-content">
            <div>
                <img className='w-44' src={logo} alt="" />
                <p>Nafis Photographpy Ltd.</p>
                <p>Copyright © 2022 - All right reserved by Nafis Photography Ltd.</p>
            </div>
            <div>
